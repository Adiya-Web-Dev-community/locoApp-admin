...
function Report() {
    ...
    const currentBlogs = response?.slice(indexOfFirstItem, indexOfLastItem);
                                ...
                                currentBlogs?.map((blog: any, i: number) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-center">
                                            {blog?.reportedBy?.name}
                                        </div>
                                        <span className="font-semibold text-center rounded-full">
                                            {blog?.reportedUser?.name}
                                        </span>
                                        <span className="font-semibold text-center rounded-full">
                                            {blog?.reportedPost?._id}
                                        </span>
